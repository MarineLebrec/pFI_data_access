...
Installing necessary functions to run analysis:
Include code "import pfi" within Python to use module.

Requirements for running notebook:
Directory of raw FloZF files in master_data directory, as follows:
pFI_Analysis/master_data/
